...
class HelpCog(commands.Cog):
    ...
    async def help(self, ctx):  
        ...
        embed.add_field(name="version", value="Prints my protocol version and what is new with this version\n - Alias: `changelog`", inline=False)
